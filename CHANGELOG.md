...
- Fix: support for Node v16 and add for v18 (#392)
  - Update gulp-sass (the new version does not use node-sass which needs python v2 and other deprecated dependencies)
...
- Refactor: converts the dropdown component from class to function component (#361)
